                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
                        @hasanyrole('Admin|Manager')
                            <a href="{{ route('suppliers.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 w-full sm:w-auto">
                                Tambah Supplier
                            </a>
                        @endhasanyrole
                        <!-- [BARU V1.14.0] Form Pencarian -->
                        <form action="{{ route('suppliers.index') }}" method="GET" class="w-full sm:w-auto sm:max-w-xs ml-auto">
