        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{-- [BARU] Tambahkan enctype="multipart/form-data" untuk mengizinkan upload file --}}
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {{-- [BARU] Tambahkan input untuk gambar produk --}}
                            <div>
                                <x-input-label for="image" value="Gambar Produk (Opsional)" />
                                ...
                                <p class="mt-1 text-sm text-gray-500" id="file_input_help">PNG, JPG, atau GIF (MAX. 2MB).</p>
