            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end mb-4">
                        ...
                        <a href="{{ route('sale-returns.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                            {{ __('+ Tambah Retur') }}
                        </a>
                        @endcan
                    </div>
                        ...
                        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                            <thead class="ltr:text-left rtl:text-right">
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Invoice Penjualan</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{ $loop->iteration + $saleReturns->firstItem() - 1 }}</td>
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $return->return_code }}</td>
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $return->sale->invoice_number }}</td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="7" class="text-center py-4 text-gray-500">Tidak ada data retur penjualan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
