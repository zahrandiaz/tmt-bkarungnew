        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Daftar Piutang (Penjualan Belum Lunas)</h3>
                                ...
                                @forelse ($receivables as $index => $sale)
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            {{-- Nanti kita akan buat halaman khusus untuk kelola pembayaran --}}
                                            <a href="{{ route('sales.show', $sale->id) }}" class="font-medium text-blue-600 hover:underline">Kelola</a>
                                        </td>
                                    </tr>
                                @empty
